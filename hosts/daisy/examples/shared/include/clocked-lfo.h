...
struct sig_dsp_ClockedLFO {
    ...
    struct sig_dsp_WavetableBankOscillator* lfo;
...
void sig_dsp_ClockedLFO_generate(void* signal) {
    ...
    self->lfo->wavetables = self->wavetables;
...
struct sig_dsp_ClockedLFO* sig_dsp_ClockedLFO_new(
    ...
    self->lfo = sig_dsp_WavetableBankOscillator_new(allocator, context);
...
void sig_dsp_ClockedLFO_destroy(struct sig_Allocator* allocator,
    ...
    sig_dsp_WavetableBankOscillator_destroy(allocator, self->lfo);
    self->lfo = NULL;

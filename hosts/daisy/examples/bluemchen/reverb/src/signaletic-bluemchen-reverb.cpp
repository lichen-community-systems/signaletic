...
struct sig_daisy_FilteredCVIn* timeScaleKnob;
...
void buildSignalGraph(struct sig_SignalContext* context,
    ...
    mixKnob->parameters.control = sig_daisy_Bluemchen_CV_IN_KNOB_1;        mixKnob->parameters.scale = 2.0f;
